structure(list("kappa2", structure(list(function (ratings, weight = c("unweighted", 
    "equal", "squared"), sort.levels = FALSE) 
{
    ...
    rval <- structure(list(method = paste("Cohen's Kappa for 2 Raters (Weights: ", 
        ...
        raters = nr, irr.name = "Kappa", value = value, stat.name = "z", 
        statistic = u, p.value = p.value), class = "irrlist")
    return(rval)
    ...
    sort.levels = FALSE) 
{
    ...
    rval <- structure(list(method = paste("Cohen's Kappa for 2 Raters (Weights: ", 
        ...
        statistic = u, p.value = p.value), class = "irrlist")
    return(rval)
}), names = c("package:irr", "")), c("package:irr", "namespace:irr"
), c(TRUE, FALSE), c(FALSE, TRUE)), names = c("name", "objs", 
